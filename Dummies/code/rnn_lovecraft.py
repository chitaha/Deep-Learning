"""
The rnn_lovecraft.py module reads this text and uses an RNN to predict
how  H.P.  Lovecraft would add words to phrases. I’m sure we can all agree that
this  application is vitally important to humanity’s cultural development, and
"""
...
with open('lovecraft.txt', 'r') as f:
    ...
    if python3:
        ...
        input_str = input_str.decode(
            'utf-8').translate(None, string.punctuation)
...
with tf.Session() as sess:
    ...
    while accuracy < 95.:
        for i in range(batch_size):
            ...
            label_block[i, :] = np.eye(vocab_size)[
                input_vals[offset + input_size]]
        _, corr = sess.run([optimizer, correct], feed_dict={
                           input_holder: input_block,
