"""
The code gru_lovecraft.py performs the same text prediction as the code
in rnn_lovecraft.py and lstm_lovecraft.py . The only difference is
that it creates an RNN using a GRUCell
"""
