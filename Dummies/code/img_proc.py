"""
The code img_proc.py module demonstrates how an application can
remove noise from an image by performing convolution with a 3-x-3 filter whose
elements equal 1/9. In addition to convolution, this module performs four
operations:
...
The img_proc.py module reads data from input_aircraft.png and writes
its result to output_aircraft.png .
"""
