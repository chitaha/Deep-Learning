"""
The code lstm_lovecraft.py module performs the same text prediction
as the code in the rnn_lovecraft.py module. The only difference is that
it creates an RNN based on a BasicLSTMCell instead of a BasicRNNCell.
"""
