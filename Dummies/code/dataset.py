"""
The code in dataset.py demonstrates how you can create and process data-
sets. The module starts by creating an Example , writing the Example ’s data
to a TFRecord file, and loading the file’s data into a TFRecordDataset . Then
it creates two more datasets, processes them using Dataset methods, and
iterates through their elements.
"""
