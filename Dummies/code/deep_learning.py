"""
Like the multi_regression.py module, deep_learning.py loads and
classifies images from the MNIST dataset. But instead of using
logistic regression,the module creates a neural network made
