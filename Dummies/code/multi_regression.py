"""
The code multi_regression.py demonstrates how you can use multino-
mial regression to load and classify images from the MNIST dataset
"""
    ...
    for epoch in range(num_epochs):
        ...
        for batch in range(num_batches):
            ...
            _, lossVal = sess.run([optimizer, loss], feed_dict={
                                  image_holder: image_batch, label_holder:
                                  label_batch})
