...
optimizer = tf.train.GradientDescentOptimizer(
    learn_rate).minimize(loss, global_step=step_var)
...
checkpoint_hook = tf.train.CheckpointSaverHook(
    checkpoint_dir='ckpt_dir', checkpoint_basename='output', save_steps=10)
summary_hook = tf.train.SummarySaverHook(
    save_steps=10, output_dir='log', summary_op=summary_op)
