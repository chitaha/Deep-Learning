"""
The code in the experiment.py module demonstrates how experiments
can be created and launched. The experiment analyzes MNIST data using a
DNNClassifier similar to the estimator from dnn_class.py .
"""
